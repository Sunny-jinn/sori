...
import bg_third from '../assets/images/img_techno_background.png'
...
export const FourthPage = () => {
  const { title, name, content, buttonText } = musicContents.techno
    ...
    <Section>
      <Wrapper>
        ...
        <ContentWrapper>
          ...
          />
          <CardSections cards={musicImages.techno} />
        </ContentWrapper>
      </Wrapper>
    </Section>
  )
